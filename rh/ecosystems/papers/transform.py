"""Transform Papers API payloads into normalized table records."""
...
class PapersTransform(TransformInterface):
    """Transformer for Ecosyste.ms Papers extract payloads.
    ...
    def normalize_paper_projects(
        ...
        """Normalize project payloads for ``_ecosystems_projects``.

        Parameters
        ----------
        projects : list[dict]
            Raw project records returned by the Papers API.
    ...
    def normalize_paper_project_mentions(
        ...
        """Normalize mention payloads for ``_ecosystems_mentions``.

        Parameters
        ----------
        mentions : list[dict]
            Raw mention records returned by the Papers API.
