"""Logging configuration for the Awesome dataset toolkit."""

from __future__ import annotations

import logging

from awesome.utils import Utils
...
class AwesomeLogger:
    ...
    def __init__(self, name: str) -> None:
        ...
        self.timestamp: int = Utils.get_timestamp()
    ...
    def setup_file_logging(self, prefix: str) -> str:
        ...
        ----------
        prefix : str
            Filename prefix (for example, ``"awesome"``).
